namespace KarisMissionChoir.DAL.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Sex = c.Int(),
                        IsKarisMember = c.Boolean(),
                        Discriminator = c.String(nullable: false, maxLength: 128),
                        UserAddresses_AddressID = c.Int(),
                    })
                .PrimaryKey(t => t.UserId)
                .ForeignKey("dbo.Address", t => t.UserAddresses_AddressID)
                .Index(t => t.UserName, unique: true, name: "UserNameIndex")
                .Index(t => t.UserAddresses_AddressID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Users", "UserAddresses_AddressID", "dbo.Address");
            DropForeignKey("dbo.UserRoles", "RoleId", "dbo.Roles");
            DropIndex("dbo.UserLogins", new[] { "IdentityUser_Id" });
            DropIndex("dbo.UserClaims", new[] { "IdentityUser_Id" });
            DropIndex("dbo.Users", new[] { "UserAddresses_AddressID" });
